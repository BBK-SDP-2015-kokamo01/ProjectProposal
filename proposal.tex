...
\abstract{Approximately 89 million tonnes of food are wasted each year in the EU. This figure could rise to as much as 126 million tonnes by 2020 if no action is taken.\cite{FoodWaste} This colossal amount of waste has devastating impacts on the economy and society. The majority of this statistic is accountable to the domestic household. Poor inventory keeping and busy lifestyles of the consumer all attribute to waste. This project proposes the exploration of item level identification of groceries using Radio Frequency Identification (RFID) together with the use of an Internet enabled fridge. The task of inventory management is delegated to a RFID interrogator embedded fridge. And granular item level information such as use-by-dates and batch level data are provided by RFID tags. The sensor aware appliance will monitor the presence of groceries residing inside, enabling the accurate tracking and digital representation of the contents. This information will be ubiquitously available to the consumer though a Smartphone application, allowing access to their home food stock at any time; any place, reducing the likelihood excessive purchasing or forgetting to consume foods before the use-by-date. By relieving the consumer of the responsibility of inventory memorisation, this technology is intended to empower the consumer to reduce food and monetary waste.}
\newpage
...
\vspace{\baselineskip}Section \textbf{\emph{two}} presents the aims, objectives and limitations of the project. Here the intent of the project is defined and the goal of the end product. Aims will present a broad view of the idea and describe the influences the research has had on end product. Objectives will present a manageable subset of the project and highlight the learning outcomes. Current limitations will also be discussed in preparation for the development phase.
...
\bibitem{REST}F. Roy. "Representational state transfer." Architectural Styles and the Design of Netowork-based Software Architecture (2000): 76-85.
