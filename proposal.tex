...
seen as important by consumers.}} {\textsc{- Food Standard Agency}\textit{`country of origin labelling guidence'}\cite{FSA}
\vspace{\baselineskip}
...
%9	
   	...
   	\begin{flushleft}Demonstrate the functionality of the prototype and critically assess the product. Reflect on the development process and discuss leaning outcomes. 
...
Timetable provided goes against agile so change could happen testing is done at every stage so will be ommited to remove duplicatiion 
\vspace{\baselineskip}
...
\begin{itemize}
  ...
  \end{itemize}
\paragraph{\textbf{Week 5-7: 6th July-20th July:}} \textbf{\emph{Development stage 5: }}
...
\paragraph{\textbf{Week 7-10: 27th July-10th August:}} \textbf{\emph{Development stage 6: }}
...
\paragraph{\textbf{Week 11: 17th August:	}} \textbf{\emph{Development stage 6: }}
...
%pichart ref
\bibitem{WRAP}P.Whitehead \emph{et al}, \emph{Estimates of waste in the food and drink supply chain}, WRAP, July 2002.
\vspace{\baselineskip}

\bibitem{obesity}M. White, \emph{Food access and obesity.} Obesity reviews 8.s1 (2007): 99-107.
\vspace{\baselineskip}

\bibitem{statistic}Government Statistical Service, \emph{Uk Statistics on waste 2010-2012 }, Department for Environment, food and Rural Affairs, March 2015
\vspace{\baselineskip}

\bibitem{motivation}Graham-Rowe, Ella, Donna C. Jessop, and Paul Sparks.\emph{Identifying motivations and barriers to minimising household food waste.} Resources, Conservation and Recycling 84 (2014): 15-23.
\vspace{\baselineskip}

\bibitem{horsy}Environment, Food and Rural Affairs Committee, \emph{Food Contamination},vol. 1, authority of the House of Commons London: The Stationery Office Limited, 2013.
\vspace{\baselineskip}

\bibitem{anarobic}Li, Lei, et al. \emph{Early warning indicators for monitoring the process failure of anaerobic digestion system of food waste.} Bioresource technology 171 (2014): 491-494.
\vspace{\baselineskip}

\bibitem{nano}Handford, Caroline E., et al, \emph{Implications of nanotechnology for the agri-food industry: Opportunities, benefits and risks}, Trends in Food Science \& Technology 40.2 2014: 226-241.
\vspace{\baselineskip}

\bibitem{georgeR}G. Rouss
\vspace{\baselineskip}

\bibitem{rfidFood} R. Chen, \emph{Using RFID Technology in Food Produce Traceability},WSEAS Transaction on information science and applications, November 2008
\vspace{\baselineskip}

\bibitem{FSA}Food Standard Agency, \emph{Country of Origin Labelling Guidance}, October 2008
\vspace{\baselineskip}
...
\bibitem{myGrocer}P. Kourouthanasis, D. Spinellis, G. Roussos, G. Giaglis, \emph{Intelligent cokes and diapers: MyGrocer ubiquitous computing environment}, First International Mobile Business Conference, pp. 150--172, July 2002.
\vspace{\baselineskip}

\bibitem{weiser}M. Weiser, \emph{Creating the invisible interface}, 7th annual ACM symposium on User interface software and technology, 1994
...
\bibitem{pervasiveComp}P. Kourouthanassis, G. Roussos, \emph{Developing Consumer- Friendly Pervasive Retail Systems}, IEEE, Page(s): 32	- 39, 2003
\vspace{\baselineskip}
