...
\lhead{}
\rhead{}
\chead{Ubiquitous Consumer Inventory Management System For Waste Prevention}
\lfoot{Chapter \thesection}
...
\title{
    ...
    {\LARGE Ubiquitous Consumer Inventory Management System For Waste Prevention}\\[0.2\baselineskip]
    \rule{\textwidth}{0.4pt}\vspace*{-\baselineskip}\vspace{3.2pt}
    \rule{\textwidth}{1.6pt}\\[\baselineskip]
    \scshape
}

\author{Keimi Okamoto \\[9pt]
	MSc Computer Science\\
	Birkbeck, University of London \\[9pt]
...
\begin{document}
	...
	\thispagestyle{empty}
	\begin{center}
	\textsl{This proposal is substantially the result of my own work, expressed in my own words, except where explicitly indicated in the text. I give my permission for it to be submitted to the JISC Plagiarism Detection Service.}
	\end{center}
	\newpage
%........................
% Contents
...
%\begin{preview}
\tikzset{every picture/.style={xscale=0.69,transform shape}}
  \begin{gantt}{10}{15}
    \begin{ganttitle}
    \numtitle{1}{1}{15}{1}
    \end{ganttitle}
    ...
    \ganttbar{2}{2}{3}
    \ganttbarcon{3}{8}{2}
    \ganttmilestone[color=cyan]{4}{4}
    \ganttbar{5}{2}{2}
    \ganttbar[color=cyan]{6}{4}{4}
    \ganttbar{7}{4}{2}
    \ganttcon{4}{5}{4}{7}
    \ganttmilestonecon{8}{7}
    \ganttbarcon{9}{8}{2}
  \end{gantt}
%\end{preview}
